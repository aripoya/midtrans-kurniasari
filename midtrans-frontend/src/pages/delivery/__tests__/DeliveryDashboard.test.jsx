...
describe('DeliveryDashboard', () => {
  ...
  describe('API Integration', () => {
    it('should fetch orders on component mount', async () => {
      ...
      await waitFor(() => {
        expect(mockedAdminApi.getDeliveryOrders).toHaveBeenCalled();
      });
    });
  ...
  describe('Orders Display', () => {
    ...
    it('should display orders table when orders exist', async () => {
      mockedAdminApi.getDeliveryOrders.mockResolvedValueOnce({
        success: true,
        data: { orders: mockOrders },
        error: null
  ...
  describe('Photo Upload Functionality', () => {
    it('should open photo upload modal when upload button clicked', async () => {
      ...
      expect(screen.getByText('Upload Foto Pengiriman')).toBeInTheDocument();
    });

    it('should handle file selection in photo upload', async () => {
      mockedAdminApi.getDeliveryOrders.mockResolvedValueOnce({
        success: true,
        data: { orders: mockOrders },
        error: null
      ...
      const fileInput = screen.getByLabelText(/pilih foto/i);
  ...
  describe('Edge Cases', () => {
    it('should handle malformed order data', async () => {
      const malformedOrders = [
        { id: null, customer_name: '', shipping_status: undefined },
  ...
  describe('Status Update Functionality', () => {
    it('should allow status updates for valid transitions', async () => {
      ...
      // Mock status update API call (this would be a separate method)
      const mockUpdateStatus = vi.fn().mockResolvedValueOnce({
        success: true,
        data: { success: true },
        error: null
      });
      mockedAdminApi.updateOrderShippingStatus = mockUpdateStatus;
